package at.twif.picdb.controllers;
...
import at.twif.picdb.viewmodels.MainWindowPM;
import at.twif.picdb.viewmodels.PicturePM;
...
public class MainWindowController implements Initializable, PictureNavHandler {
    ...
    public void showPhotographersAction(ActionEvent actionEvent) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/at/twif/picdb/views/PhotographersView.fxml"));
        try {
